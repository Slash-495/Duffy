...
import { TrophyIcon, FlameIcon, MapIcon, TargetIcon, BotIcon, MicIcon } from 'lucide-react';
import { Link } from 'react-router';
import LessonViewer from '../components/learning/LessonViewer';
import QuizUI from '../components/learning/QuizUI';
import PronunciationCard from '../components/learning/PronunciationCard';
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-base-100 rounded-3xl p-6 shadow-sm border border-base-200 relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-10">
              <MicIcon className="size-24" />
            </div>
            <h3 className="font-bold text-xl">Voice Analysis</h3>
            <p className="text-base-content/70 text-sm mt-2 mb-6 max-w-[80%]">
              Practice your pronunciation and get instant feedback from our AI coach.
            </p>
            <button 
